...
public class PoemGenerator2 {
    ...
    public static void main(String[] args) {
        ...
        final UnboundedMarkovChain<String> markovChain = Stream.of("/pop.txt", "/ryback.txt", "/rusl.txt")
                .map(fileName -> PoemGenerator2.class.getResource(fileName))
                .map(PoemGenerator2::readAllLines)
                ...
                .collect(UnboundedMarkovChain.collector(2, "." + System.lineSeparator(), PoemGenerator2::isStartingKey));

        IntStream.range(0, 25)
                .mapToObj(i -> markovChain.stream(markovChain.randomStartingKey())
                        .limit(35)
                        .reduce("", PoemGenerator2::joinElements))
